...
class event_mgr {
    ...
    private:
        SDL_Event event;
        vector<event_status> event_container = {
        ...
        list<int> to_clear;
        vector<keypress> curr_pressed_keys = {
            {SDLK_UNKNOWN, false},
        ...
        int get_event_container_pos(int p_event_type);
        int get_curr_pressed_keys_pos(int p_vkeycode);
        void manage_keypress(int p_ev_cont_pos);
};